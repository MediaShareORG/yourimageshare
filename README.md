...
Five official SDKs, so you don't have to hand-roll the HTTP calls, plus a
...
- **Go:** [`github.com/MediaShareORG/yourimageshare-api/go`](https://pkg.go.dev/github.com/MediaShareORG/yourimageshare-api/go) - `go get github.com/MediaShareORG/yourimageshare-api/go`. Zero dependencies (standard library only), Go 1.18+. Source: [/go](go).
